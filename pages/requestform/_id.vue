  ...
  <v-container class="py-0 my-0">
    ...
    <template>
      <v-row justify-content="space-between" v-if="checkEdit(this.requestForm)">
        ...
        <v-col>
          <v-btn @click="showDialogUpdateRequestForm()" block large dark color="#008080">
            Update
          </v-btn>
        </v-col>
      </v-row>
      ...
      <v-row justify-content="space-between" v-if="requestForm.is_confirmed_verificator == 0">
        <v-col cols="12">
          <v-btn @click="showDialogConfirmForm('verificator')" block large dark color="#008080">
            Konfirmasi sebagai Verificator
          </v-btn>
        </v-col>
      </v-row>
      <v-row justify-content="space-between" v-if="requestForm.is_confirmed_head_dept == 0">
        <v-col cols="12">
          <v-btn @click="showDialogConfirmForm('headDept')" block large dark color="#008080">
            Konfirmasi sebagai Head Dept
          </v-btn>
        </v-col>
      </v-row>
        ...
        <v-container fluid fill-height grid-list-md text-xs-center class="bg">
          <v-layout row wrap align-center justify-center>
            ...
            >
              ...
              <v-row>
                <v-col cols="6">
                  <v-btn height="50px" block big dark  color="#06beb6" @click="updateRequestForm()" >Simpan</v-btn>
                </v-col>
                <v-col>
                  <v-btn height="50px" block big  @click.stop="dialogUpdateRequestForm = false ">Batal</v-btn>
                </v-col>
              </v-row>
            </v-form>
          </v-layout>
