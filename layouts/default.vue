              ...
              <v-item-group v-model="preferences.theme.color.primary" mandatory>
                <v-row>
                  <v-col v-for="color in colors" :key="color" cols="3" class="pa-0 my-2">
                    <v-item :value="color" v-slot:default="{ active, toggle }">
                      <v-card
                        class="mx-1"
                        :style="{
                          border: '2px solid',
...
<script>
  ...
  export default {
    ...
    watch: {
      'preferences.lang': function(value) {
        this.$vuetify.lang.current = value
        this.savePreferences()
      },
      // watch changes in dark theme mode
      'preferences.theme.darkMode': function(value) {
        this.$vuetify.theme.dark = value
        this.savePreferences()
      },

      // watch changes in primary color
      'preferences.theme.color.primary': function(value) {
      ...
      'preferences.theme.color.secondary': function(value) {
      ...
      'preferences.theme.color.accent': function(value) {
